  ...
  return (
    <div className="px-5 border-b-[1px] xl:px-[150px]" id="contact">
      <div className="flex flex-col md:px-[100px] md:flex-row justify-between">
        <div className="text-[50px] lg:text-[60px] xl:text-[80px]  text-center textImage">
          GET IN TOUCH
        </div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between justify-center lg:justify-center md:px-[100px] pt-[38px] items-center ">
